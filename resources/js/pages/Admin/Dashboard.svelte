<script>
    ...
    // 👇👇👇 TUGAS SAYYID: SCAN QR CODE (FRONTEND) 👇👇👇
    // Membuka kamera HP mahasiswa dan membaca QR Code menggunakan library 'html5-qrcode'
...
<div class="min-h-screen bg-slate-100 flex">
    ...
    <aside class="w-72 bg-white border-r border-slate-200 p-6 flex flex-col">
        <div class="mb-10">
            <h1 class="text-3xl font-bold text-[#062B66]">QR-Attend</h1>
        </div>
    ...
    <main class="flex-1 p-10 overflow-auto">
        ...
        <!-- SCAN QR -->
        <div
            class="bg-white rounded-3xl shadow-sm p-10 mb-8 border border-slate-200"
        >
            <div class="text-center max-w-lg mx-auto">
                ...
                {#if scanResult}
                    <div
                        class="mb-6 p-6 rounded-2xl bg-green-50 border border-green-200"
                    >
                ...
                {#if scanError}
                    <div
                        class="mb-6 p-6 rounded-2xl bg-red-50 border border-red-200"
                    >
                        <div class="text-4xl mb-3">❌</div>
